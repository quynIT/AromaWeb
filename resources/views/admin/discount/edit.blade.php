...
@section('title', 'Trang cập nhật mã giảm giá')
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="name" id="name" placeholder="Tên thương hiệu" type="text"
                                        class="form-control" value="{{ $discount->name }}">
                                    <input name="id" id="name" placeholder="Name" type="hidden"
                                        class="form-control" value="{{ $discount->id }}">
                                    @error('name')
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="code" id="code" placeholder="Mã giảm giá" type="text"
                                        class="form-control" value="{{ $discount->code }}">
                                    <input name="id" id="code" type="hidden" type="text" class="form-control"
                                        value="{{ $discount->id }}">
                                    @error('code')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="price" id="price" placeholder="Số tiền giảm" type="text"
                                        class="form-control" value="{{ $discount->price }}">
                                    @error('price')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="begin" id="begin"type="date" class="form-control"
