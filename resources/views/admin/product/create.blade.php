                ...
                <div class="page-title-heading">
                    ...
                    <div>
                        ...
                        <div class="page-title-subheading">
                            giao diện, Tạo, cập nhât, xóa và quản lý.
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <select required name="brand_id" id="brand_id" class="form-control">
                                        <option value="">-- Nhãn hàng --</option>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <textarea required name="descipition" id="content" placeholder="Mô tả" type="text" class="form-control">{{ old('description') }}</textarea>
                                    <p>
