...
@section('title', 'Trang thêm nhà cung cấp')
@section('content')
                    ...
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.supplier.store') }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="address" id="address"type="text" placeholder="Địa chỉ nhà cung cấp"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="country" id="country" type="text" placeholder="Quốc gia" class="form-control"
                                        value="{{ old('country') }}">
                                    @error('country')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
